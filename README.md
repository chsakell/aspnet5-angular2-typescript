...
<li>Application uses SQL Server so in case you want to change this, you need to alter the corresponding parts (not available). Continue only if you have an instance of SQL Server available.</li>
<li>Open <strong>appsettings.json</strong> file and alter the database connection string to reflect your SQL Server environment.</li>
